...
<header class="topbar"><a class="brand" href="#hero" aria-label="Hadix AI, início"><span class="brand-mark" aria-hidden="true">✳</span>hadix<span class="brand-ai">.ai</span></a><nav class="nav" aria-label="Principal"><a href="#platform">Plataforma</a><a href="#pipeline">Pipeline</a><a href="#agents">Agentes</a></nav><a class="btn header-cta" href="#cta">Explorar possibilidades <span aria-hidden="true">↗</span></a><button class="menu-toggle" id="menuToggle" aria-expanded="false" aria-controls="mobileNav" aria-label="Abrir menu"><span></span><span></span></button></header>
<nav class="mobile-nav" id="mobileNav" aria-label="Navegação mobile" hidden><a href="#platform">Plataforma</a><a href="#pipeline">Pipeline</a><a href="#agents">Agentes</a><a href="#cta">Explorar possibilidades ↗</a></nav>
...
<main id="main">
<section class="hero wrap" id="hero"><div class="hero-copy"><p class="eyebrow"><span class="status-dot"></span> Inteligência conectada. Ação autônoma.</p><h1>Sinal vira<br><span class="accent">decisão.</span></h1><p class="hero-sub">Seus dados já têm as respostas.<br>Conecte-os a agentes que percebem, raciocinam e agem. Do primeiro sinal ao próximo passo.</p><div class="hero-actions"><a href="#platform" class="btn btn-lime">Conheça o Hadix <span aria-hidden="true">↗</span></a><a href="#pipeline" class="btn">Explore o pipeline <span aria-hidden="true">↓</span></a></div><div class="hero-note"><span class="tiny-cross">+</span> Menos operação manual. Mais possibilidades.</div></div>
